...
void afficherEtudiant(EtudiantRepere *etu){
    printf("le nom de l'etudiant est %s son age est %d sa note globale est %d sa date de naissance est %d/%d/%d \n",etu->nom,etu->age,etu->note,etu->dateNaissance.jour,etu->dateNaissance.mois,etu->dateNaissance.annee); 
}
